...
function CallUI({ agentId, candidateName }: { agentId: string; candidateName: string }) {
...
export default function CallInterface({ agentId, candidateName }: { agentId: string; candidateName: string }) {
  return (
    <ConversationProvider>
      <CallUI agentId={agentId} candidateName={candidateName} />
    </ConversationProvider>
  )
}
