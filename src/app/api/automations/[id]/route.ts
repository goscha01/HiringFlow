...
export async function PATCH(request: NextRequest, { params }: { params: { id: string } }) {
  ...
  const updated = await prisma.automationRule.update({
    ...
    data: {
      ...
      ...(body.channel !== undefined && { channel: body.channel === 'sms' ? 'sms' : 'email' }),
      ...(body.emailTemplateId !== undefined && { emailTemplateId: body.emailTemplateId || null }),
      ...(body.smsBody !== undefined && { smsBody: body.smsBody || null }),
